...
const QUESTION_MAP = {
  ...
  3: {
    type: "mcq",
    title: "Câu 3",
    question: "Theo phép biện chứng duy vật, các sự vật hiện tượng:",
    options: [
      "Tồn tại độc lập, không liên hệ",
      "Luôn đứng yên",
      "Có mối liên hệ với nhau",
      "Chỉ thay đổi khi con người tác động",
    ],
    correctIndex: 2,
  },
  4: {
  ...
  8: {
    ...
    title: "Câu 8",
    question:
      "Theo chủ nghĩa duy vật biện chứng, mọi sự vật hiện tượng đều luôn vận động và phát triển.",
    options: ["Đúng", "Sai"],
    correctIndex: 0,
  },
  9: {
    ...
    title: "Câu 9",
    question:
      "Theo triết học Mác – Lênin, ý thức tồn tại độc lập và quyết định vật chất.",
    options: ["Đúng", "Sai"],
    correctIndex: 1,
  },
};
