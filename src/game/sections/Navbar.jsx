...
export default function Navbar({ activeTab, onTabChange }) {
  ...
  useEffect(() => {
    ...
    // Theory section IDs across the theory slide sections
    const THEORY_SECTION_IDS = [
      "ton-tai",
      "tat-yeu",
      "mind-map-5-1-2",
      "dau-tranh-giai-cap",
      "dau-tranh-giai-cap-2",
      "luc-luong-tham-gia",
      "thuc-chat-dau-tranh",
      "khong-phai-dau-tranh",
      "bieu-hien-dau-tranh",
      "lien-minh-giai-cap",
      "dau-tranh-giai-cap-vo-san",
      "hai-giai-doan-chinh",
      "truoc-khi-gianh-chinh-quyen",
      "sau-khi-gianh-chinh-quyen",
      "nhiem-vu-chien-luoc",
      "ket-luan-vo-san",
      "vi-du-thuc-tien",
    ];
  ...
  const isGray = active !== "#hero" && activeTab !== "ai";

  return (
    <div className="navbar-theory-wrapper w-full flex justify-center z-[100] fixed top-6 pointer-events-none">
      <nav
        className={`navbar-theory pointer-events-auto ${isGray ? "nav-gray" : ""} navbar-glass`}
      >
